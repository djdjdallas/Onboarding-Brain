 ...
 *
 * Async because supabase-js builds a Realtime client at construction, which
 * needs a global WebSocket. Node < 22 lacks one, so we polyfill with `ws`
 * (a no-op on Vercel's newer Node and in the browser).
 */
